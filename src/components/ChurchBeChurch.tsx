...
const ChurchBeChurch = () => {
  ...
  const whatsappNumber = "5524999999999";
  const whatsappMessage = "Olá! Gostaria de saber mais sobre como ser generoso na Capela Church.";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-muted rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
              Entre em contato conosco pelo WhatsApp e solicte nossa prestação de contas de forma transparente.
            </p>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold px-8 py-4 rounded-lg transition-colors shadow-lg hover:shadow-xl"
            >
